...
from sklearn.metrics import pairwise_distances, confusion_matrix, accuracy_score,precision_score, recall_score, accuracy_score
...
# folder_path = r"tdma"
# image_path = r"D:\img.jpg"
# face = cv2.imread(image_path)
# face_copy = face.copy()

# print(get_predictions(image_copy=face_copy,label_encoder=label_encoder,model_thr=model_thr,models=models, tflite_model=tflite_model))
